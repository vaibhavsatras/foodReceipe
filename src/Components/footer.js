...
function Footer() {
  return (
    <>      
       <div className='relative  w-[75%] mx-auto bottom-0'>
       <footer className="footer  footer-center p-10 bg-white text-base-content rounded shadow-lg ">
  <nav className="grid grid-flow-col gap-4">
    <Link className="link link-hover" to={'/Receipes'}>Receipes</Link>
  ...
  <aside>
    <p>Copyright © 2024 - All right reserved by VBS</p>
  </aside>
</footer>
       </div>
