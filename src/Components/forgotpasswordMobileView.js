...
function ForgotPasswordMobileView() {
  ...
  return (
    <>
      ...
      <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 text-xl text-black mt-2 me-3">✕</button>
        ...
        <form className="space-y-6 px-6 lg:px-2 mx-auto w-[100%] pb-4 sm:pb-6 xl:pb-8" onSubmit={handleSubmit(ForGotPassword)}>
...
export default ForgotPasswordMobileView
