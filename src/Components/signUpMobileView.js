...
function SignUpMobileView() {
  ...
  return (
    <>
        <div>
      <dialog id="my_modal_1_1" className="modal">
      ...
      <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 text-lg text-black mt-3 me-3 ">✕</button>
        ...
        <form className="space-y-5 px-6 lg:px-2 mx-auto w-[100%] pb-4 sm:pb-6 xl:pb-8 overflow-y-hidden" onSubmit={handleSubmit(SignupForm)} >
                ...
                <button className=' border hover:bg-pink-600 border-pink-700 px-3 py-1 rounded-lg bg-pink-700 text-white'
                  type='submit'>Submit</button>

                  <span className='text-sm'>have already user?<span className='cursor-pointer text-blue-700 hover:text-blue-500 transition-all ease-in-out duration-150 text-sm ps-1'  onClick={()=>document.getElementById('my_modal_2_1').showModal()}>Sign In</span></span>
